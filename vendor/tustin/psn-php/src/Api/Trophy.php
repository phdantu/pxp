...
class Trophy extends AbstractApi
{
    ...
    }//alterei para para de dar erro de pegar propriedade de null
    ...
    public function bronze(object $trophyTypes)
    {
        return $trophyTypes->bronze;
    }

    public function gold(object $trophyTypes)
    {
        return $trophyTypes->gold;
    }

    public function silver(object $trophyTypes)
    {
        return $trophyTypes->silver;
    }

    public function platinum(object $trophyTypes)
    {
        return $trophyTypes->platinum;
    }
}
